...
function(target_get_dynamic_library DEST TARGET)
    ...
    if(result)
        ...
        if(NOT __DREAMCAST__)
        if(NOT ${result} MATCHES ".*\\.so.*")
            message(FATAL_ERROR "\"${result}\" is not a .so shared library")
        endif()
    else()
        # Handle Dreamcast-specific static library case, e.g., skipping dynamic checks for static libs
        message(STATUS "Skipping .so check for Dreamcast static libraries: ${result}")
    endif()
        endif()
    else()
